"""Model registry for rating experiments."""
...
from rating_types import ModelSpec, OrdinalLogisticClassifier
...
class ModelRegistry:
    ...
    def get_specs(self) -> List[ModelSpec]:
        ...
        specs = [
            ...
            ModelSpec(
                name="ridge_regression_round",
                family="regressor_dense",
                build=lambda: Ridge(alpha=1.0),
            ),
            ModelSpec(
                name="ordinal_logistic",
                family="ordinal",
                build=lambda: OrdinalLogisticClassifier(
                    min_label=1,
                    max_label=5,
                    random_state=self.random_state,
                ),
