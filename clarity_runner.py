...
def default_config() -> RunConfig:
    ...
    return RunConfig(
        ...
        output_cv_folds_csv="classification_results_cv_folds.csv",
        output_model_summary_csv="classification_results_model_summary.csv",
        k_values=[3, 5, 8, 10],
...
class ExperimentRunner:
    ...
    def _build_split_output_tables(
        ...
        if include_test_row:
            if test_metrics is None or best_k is None or best_model_name is None:
                raise ValueError("include_test_row=True requires test metrics and best model details")
